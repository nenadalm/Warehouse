...
return (function (e){
var G__16268_16269 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notification_DASH_close,k], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__16268_16269) : re_frame.core.dispatch.call(null,G__16268_16269));
...
var notifications = (function (){var G__16289 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notifications], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__16289) : re_frame.core.subscribe.call(null,G__16289));
})();
...
return (function warehouse$notifications$views$notifications_$_iter__16290(s__16291){
return (new cljs.core.LazySeq(null,((function (notifications){
return (function (){
var s__16291__$1 = s__16291;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__16291__$1);
if(temp__4657__auto__){
var s__16291__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16291__$2)){
var c__7812__auto__ = cljs.core.chunk_first(s__16291__$2);
var size__7813__auto__ = cljs.core.count(c__7812__auto__);
var b__16293 = cljs.core.chunk_buffer(size__7813__auto__);
if((function (){var i__16292 = (0);
while(true){
if((i__16292 < size__7813__auto__)){
var vec__16302 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7812__auto__,i__16292);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16302,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16302,(1),null);
cljs.core.chunk_append(b__16293,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)));

var G__16308 = (i__16292 + (1));
i__16292 = G__16308;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16293),warehouse$notifications$views$notifications_$_iter__16290(cljs.core.chunk_rest(s__16291__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16293),null);
}
} else {
var vec__16305 = cljs.core.first(s__16291__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16305,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16305,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)),warehouse$notifications$views$notifications_$_iter__16290(cljs.core.rest(s__16291__$2)));
}
} else {
return null;
}
