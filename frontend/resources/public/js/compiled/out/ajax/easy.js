...
var G__11250 = format;
var G__11250__$1 = (((G__11250 instanceof cljs.core.Keyword))?G__11250.fqn:null);
switch (G__11250__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__11252 = cljs.core.second(format);
var G__11253 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__11252,G__11253) : ajax.easy.keyword_response_format_element.call(null,G__11252,G__11253));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__11254 = format;
var G__11254__$1 = (((G__11254 instanceof cljs.core.Keyword))?G__11254.fqn:null);
switch (G__11254__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11256_SHARP_){
return ajax.easy.keyword_response_format_element(p1__11256_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__11257){
var map__11258 = p__11257;
var map__11258__$1 = ((((!((map__11258 == null)))?(((((map__11258.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11258.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11258):map__11258);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11258__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11258__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11258__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__11258,map__11258__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__11260){
var vec__11261 = p__11260;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11261,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11261,(1),null);
var fexpr__11264_11265 = (cljs.core.truth_(ok)?h:e);
(fexpr__11264_11265.cljs$core$IFn$_invoke$arity$1 ? fexpr__11264_11265.cljs$core$IFn$_invoke$arity$1(result) : fexpr__11264_11265.call(null,result));
...
;})(h,e,map__11258,map__11258__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__11266){
var map__11267 = p__11266;
var map__11267__$1 = ((((!((map__11267 == null)))?(((((map__11267.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11267.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11267):map__11267);
var opts = map__11267__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11267__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11267__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11267__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11267__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11267__$1,cljs.core.cst$kw$body);
