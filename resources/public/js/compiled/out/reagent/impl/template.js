...
var G__18129 = o;
(G__18129[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__18138 = jsprops;
(G__18138["defaultValue"] = value);

(G__18138["onChange"] = ((function (G__18138,v,value,on_change){
return (function (p1__18135_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__18135_SHARP_);
});})(G__18138,v,value,on_change))
);

(G__18138["ref"] = ((function (G__18138,v,value,on_change){
return (function (p1__18136_SHARP_){
return (this$["cljsInputElement"] = p1__18136_SHARP_);
});})(G__18138,v,value,on_change))
);
...
var vec__18145 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18145,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18145,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18145,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___18150 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___18150 == null)){
} else {
var key_18151 = temp__4661__auto___18150;
(jsprops["key"] = key_18151);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18153 = (new reagent.impl.template.NativeWrapper());
(G__18153["name"] = c);
...
var G__18155 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__18155) : reagent.impl.template.as_element.call(null,G__18155));
} else {
...
var len__7692__auto___18161 = arguments.length;
var i__7693__auto___18162 = (0);
while(true){
if((i__7693__auto___18162 < len__7692__auto___18161)){
args__7699__auto__.push((arguments[i__7693__auto___18162]));

var G__18163 = (i__7693__auto___18162 + (1));
i__7693__auto___18162 = G__18163;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18159){
var G__18160 = cljs.core.first(seq18159);
var seq18159__$1 = cljs.core.next(seq18159);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18160,seq18159__$1);
});
...
break;
default:
var G__18167 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__18167;
continue;
...
var n__7502__auto___18170 = a.length;
var i_18171 = (0);
while(true){
if((i_18171 < n__7502__auto___18170)){
(a[i_18171] = reagent.impl.template.as_element((a[i_18171])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7502__auto___18173 = a.length;
var i_18174 = (0);
while(true){
if((i_18174 < n__7502__auto___18173)){
var val_18175 = (a[i_18174]);
if((cljs.core.vector_QMARK_(val_18175)) && ((reagent.impl.template.key_from_vec(val_18175) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18174] = reagent.impl.template.as_element(val_18175));

var G__18176 = (i_18174 + (1));
i_18174 = G__18176;
continue;
} else {
}
...
var ctx = ({});
var vec__18180 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18180,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18180,(1),null);
...
var G__18184 = (cljs.core.count(argv) - first_child);
switch (G__18184) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__18184){
