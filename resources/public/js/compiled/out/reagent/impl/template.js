...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7190__auto__,writer__7191__auto__,opt__7192__auto__){
return cljs.core._write(writer__7191__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28673 = o;
(G__28673[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6572__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6572__auto__){
var and__6572__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__6572__auto____$1)){
...
var G__28682 = jsprops;
(G__28682["defaultValue"] = value);

(G__28682["onChange"] = ((function (G__28682,v,value,on_change){
return (function (p1__28679_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__28679_SHARP_);
});})(G__28682,v,value,on_change))
);

(G__28682["ref"] = ((function (G__28682,v,value,on_change){
return (function (p1__28680_SHARP_){
return (this$["cljsInputElement"] = p1__28680_SHARP_);
});})(G__28682,v,value,on_change))
);
...
var vec__28689 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28689,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28689,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28689,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28694 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___28694 == null)){
} else {
var key_28695 = temp__4661__auto___28694;
(jsprops["key"] = key_28695);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28697 = (new reagent.impl.template.NativeWrapper());
(G__28697["name"] = c);
...
var G__28699 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28699) : reagent.impl.template.as_element.call(null,G__28699));
} else {
...
var len__7692__auto___28705 = arguments.length;
var i__7693__auto___28706 = (0);
while(true){
if((i__7693__auto___28706 < len__7692__auto___28705)){
args__7699__auto__.push((arguments[i__7693__auto___28706]));

var G__28707 = (i__7693__auto___28706 + (1));
i__7693__auto___28706 = G__28707;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7700__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28703){
var G__28704 = cljs.core.first(seq28703);
var seq28703__$1 = cljs.core.next(seq28703);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28704,seq28703__$1);
});
...
break;
default:
var G__28711 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__28711;
continue;
...
var n__7502__auto___28714 = a.length;
var i_28715 = (0);
while(true){
if((i_28715 < n__7502__auto___28714)){
(a[i_28715] = reagent.impl.template.as_element((a[i_28715])));

var G__28716 = (i_28715 + (1));
i_28715 = G__28716;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7502__auto___28717 = a.length;
var i_28718 = (0);
while(true){
if((i_28718 < n__7502__auto___28717)){
var val_28719 = (a[i_28718]);
if((cljs.core.vector_QMARK_(val_28719)) && ((reagent.impl.template.key_from_vec(val_28719) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28718] = reagent.impl.template.as_element(val_28719));
...
var ctx = ({});
var vec__28724 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28724,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28724,(1),null);
...
var G__28728 = (cljs.core.count(argv) - first_child);
switch (G__28728) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__28728){
