...
var G__18149 = o;
(G__18149[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__18150__delegate = function (args){
...
while (G__18151__i < G__18151__a.length) {G__18151__a[G__18151__i] = arguments[G__18151__i + 0]; ++G__18151__i;}
  args = new cljs.core.IndexedSeq(G__18151__a,0);
} 
return G__18150__delegate.call(this,args);};
G__18150.cljs$lang$maxFixedArity = 0;
G__18150.cljs$lang$applyTo = (function (arglist__18152){
var args = cljs.core.seq(arglist__18152);
return G__18150__delegate(args);
});
...
var G__18158 = jsprops;
(G__18158["defaultValue"] = value);

(G__18158["onChange"] = ((function (G__18158,v,value,on_change){
return (function (p1__18155_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__18155_SHARP_);
});})(G__18158,v,value,on_change))
);

(G__18158["ref"] = ((function (G__18158,v,value,on_change){
return (function (p1__18156_SHARP_){
return (this$["cljsInputElement"] = p1__18156_SHARP_);
});})(G__18158,v,value,on_change))
);
...
var vec__18165 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18165,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18165,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18165,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___18170 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___18170 == null)){
} else {
var key_18171 = temp__4661__auto___18170;
(jsprops["key"] = key_18171);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18173 = (new reagent.impl.template.NativeWrapper());
(G__18173["name"] = c);
...
var G__18175 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__18175) : reagent.impl.template.as_element.call(null,G__18175));
} else {
...
var len__7692__auto___18181 = arguments.length;
var i__7693__auto___18182 = (0);
while(true){
if((i__7693__auto___18182 < len__7692__auto___18181)){
args__7699__auto__.push((arguments[i__7693__auto___18182]));

var G__18183 = (i__7693__auto___18182 + (1));
i__7693__auto___18182 = G__18183;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18179){
var G__18180 = cljs.core.first(seq18179);
var seq18179__$1 = cljs.core.next(seq18179);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18180,seq18179__$1);
});
...
break;
default:
var G__18187 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__18187;
continue;
...
var n__7502__auto___18190 = a.length;
var i_18191 = (0);
while(true){
if((i_18191 < n__7502__auto___18190)){
(a[i_18191] = reagent.impl.template.as_element((a[i_18191])));

var G__18192 = (i_18191 + (1));
i_18191 = G__18192;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7502__auto___18193 = a.length;
var i_18194 = (0);
while(true){
if((i_18194 < n__7502__auto___18193)){
var val_18195 = (a[i_18194]);
if((cljs.core.vector_QMARK_(val_18195)) && ((reagent.impl.template.key_from_vec(val_18195) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18194] = reagent.impl.template.as_element(val_18195));

var G__18196 = (i_18194 + (1));
i_18194 = G__18196;
continue;
} else {
}
...
var ctx = ({});
var vec__18200 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18200,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18200,(1),null);
...
var G__18204 = (cljs.core.count(argv) - first_child);
switch (G__18204) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__18204){
