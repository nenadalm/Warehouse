...
warehouse.util.revert_set = (function warehouse$util$revert_set(s,p__12346){
var vec__12347 = p__12346;
var o = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12347,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12347,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(((function (add,remove,vec__12347,o,n){
return (function (p1__12345_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(clojure.set.difference.cljs$core$IFn$_invoke$arity$2(s,remove),p1__12345_SHARP_);
});})(add,remove,vec__12347,o,n))
,add);
});
warehouse.util.revert_changes = (function warehouse$util$revert_changes(m,diff){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__12350){
var vec__12351 = p__12350;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12351,(0),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12351,(1),null);
...
return cljs.core.empty_QMARK_(cljs.core.cst$kw$data.cljs$core$IFn$_invoke$arity$1(p1__12354_SHARP_));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(item),cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__12355_SHARP_)));
});})(new_items__$1,components,item,c))
,c));
if(cljs.core.empty_QMARK_(old_item)){
var G__12356 = cljs.core.rest(new_items__$1);
var G__12357 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(components,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$id,warehouse.util.generate_component_id(components),cljs.core.cst$kw$name,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(item),cljs.core.cst$kw$tags,cljs.core.vec(cljs.core.cst$kw$tags.cljs$core$IFn$_invoke$arity$1(item)),cljs.core.cst$kw$amount,cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(item)], null));
new_items__$1 = G__12356;
components = G__12357;
continue;
} else {
var G__12358 = cljs.core.rest(new_items__$1);
var G__12359 = cljs.core.assoc_in(components,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(old_item),cljs.core.cst$kw$amount], null),(cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(item) + cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(cljs.core.second(old_item))));
new_items__$1 = G__12358;
components = G__12359;
continue;
}
}
