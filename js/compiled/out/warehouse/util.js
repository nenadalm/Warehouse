...
warehouse.util.revert_set = (function warehouse$util$revert_set(s,p__14681){
var vec__14685 = p__14681;
var o = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14685,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14685,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(((function (add,remove,vec__14685,o,n){
return (function (p1__14680_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(clojure.set.difference.cljs$core$IFn$_invoke$arity$2(s,remove),p1__14680_SHARP_);
});})(add,remove,vec__14685,o,n))
,add);
});
warehouse.util.revert_changes = (function warehouse$util$revert_changes(m,diff){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([m,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__14692){
var vec__14693 = p__14692;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14693,(0),null);
var d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14693,(1),null);
...
return cljs.core.empty_QMARK_(cljs.core.cst$kw$data.cljs$core$IFn$_invoke$arity$1(p1__14696_SHARP_));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__14701){
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(item),cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__14705_SHARP_)));
});})(new_items__$1,components,item,c))
,c));
if(cljs.core.empty_QMARK_(old_item)){
var G__14706 = cljs.core.rest(new_items__$1);
var G__14707 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(components,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$id,warehouse.util.generate_component_id(components),cljs.core.cst$kw$name,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(item),cljs.core.cst$kw$tags,cljs.core.vec(cljs.core.cst$kw$tags.cljs$core$IFn$_invoke$arity$1(item)),cljs.core.cst$kw$amount,cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(item)], null));
new_items__$1 = G__14706;
components = G__14707;
continue;
} else {
var G__14708 = cljs.core.rest(new_items__$1);
var G__14709 = cljs.core.assoc_in(components,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(old_item),cljs.core.cst$kw$amount], null),(cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(item) + cljs.core.cst$kw$amount.cljs$core$IFn$_invoke$arity$1(cljs.core.second(old_item))));
new_items__$1 = G__14708;
components = G__14709;
continue;
}
}
