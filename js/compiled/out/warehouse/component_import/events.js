...
warehouse.component_import.events.handler_item__GT_form_type = (function warehouse$component_import$events$handler_item__GT_form_type(p__16320){
...
var secret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16323__$1,cljs.core.cst$kw$secret);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16323__$1,cljs.core.cst$kw$type);
...
warehouse.component_import.events.handler_item__GT_form_item = (function warehouse$component_import$events$handler_item__GT_form_item(p__16325){
var map__16328 = p__16325;
var map__16328__$1 = ((((!((map__16328 == null)))?((((map__16328.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16328.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16328):map__16328);
var handler_item = map__16328__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16328__$1,cljs.core.cst$kw$name);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$load_DASH_providers,(function (p__16330,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16331__$1,cljs.core.cst$kw$db);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$import_DASH_providers,(function (db,p__16333){
var vec__16334 = p__16333;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16334,(0),null);
var providers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16334,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,cljs.core.cst$kw$component_DASH_providers,providers);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$import,(function (db,p__16337){
var vec__16338 = p__16337;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16338,(0),null);
var provider = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16338,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$import_DASH_document,(function (cofx,p__16341){
var vec__16342 = p__16341;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16342,(0),null);
var document = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16342,(1),null);
