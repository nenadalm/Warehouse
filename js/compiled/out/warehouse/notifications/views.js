...
return (function (e){
var G__18924_18925 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notification_DASH_close,k], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18924_18925) : re_frame.core.dispatch.call(null,G__18924_18925));
...
var notifications = (function (){var G__18926 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notifications], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__18926) : re_frame.core.subscribe.call(null,G__18926));
})();
...
return (function warehouse$notifications$views$notifications_$_iter__18927(s__18928){
...
var c__4290__auto__ = cljs.core.chunk_first(s__18928__$2);
var size__4291__auto__ = cljs.core.count(c__4290__auto__);
var b__18930 = cljs.core.chunk_buffer(size__4291__auto__);
if((function (){var i__18929 = (0);
while(true){
if((i__18929 < size__4291__auto__)){
var vec__18931 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4290__auto__,i__18929);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18931,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18931,(1),null);
cljs.core.chunk_append(b__18930,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)));

var G__18937 = (i__18929 + (1));
i__18929 = G__18937;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18930),warehouse$notifications$views$notifications_$_iter__18927(cljs.core.chunk_rest(s__18928__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18930),null);
}
} else {
var vec__18934 = cljs.core.first(s__18928__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18934,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18934,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)),warehouse$notifications$views$notifications_$_iter__18927(cljs.core.rest(s__18928__$2)));
}
} else {
return null;
}
