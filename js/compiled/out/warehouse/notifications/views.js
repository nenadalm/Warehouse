...
return (function (e){
var G__14727_14728 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notification_DASH_close,k], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__14727_14728) : re_frame.core.dispatch.call(null,G__14727_14728));
...
var notifications = (function (){var G__14748 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notifications], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__14748) : re_frame.core.subscribe.call(null,G__14748));
})();
...
return (function warehouse$notifications$views$notifications_$_iter__14749(s__14750){
return (new cljs.core.LazySeq(null,((function (notifications){
return (function (){
var s__14750__$1 = s__14750;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__14750__$1);
if(temp__4657__auto__){
var s__14750__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14750__$2)){
var c__7458__auto__ = cljs.core.chunk_first(s__14750__$2);
var size__7459__auto__ = cljs.core.count(c__7458__auto__);
var b__14752 = cljs.core.chunk_buffer(size__7459__auto__);
if((function (){var i__14751 = (0);
while(true){
if((i__14751 < size__7459__auto__)){
var vec__14761 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7458__auto__,i__14751);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14761,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14761,(1),null);
cljs.core.chunk_append(b__14752,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)));

var G__14767 = (i__14751 + (1));
i__14751 = G__14767;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14752),warehouse$notifications$views$notifications_$_iter__14749(cljs.core.chunk_rest(s__14750__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14752),null);
}
} else {
var vec__14764 = cljs.core.first(s__14750__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14764,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [warehouse.notifications.views.notification,n,k], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,k], null)),warehouse$notifications$views$notifications_$_iter__14749(cljs.core.rest(s__14750__$2)));
}
} else {
return null;
}
